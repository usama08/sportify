...
class DemoActivitylist extends StatefulWidget {
  const DemoActivitylist({Key? key}) : super(key: key);

  @override
  State<DemoActivitylist> createState() => _DemoActivitylistState();
}

class _DemoActivitylistState extends State<DemoActivitylist> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: AppButton(
                        onClicked: () {
                          ToastWidget.show(
                              'Please wait for Verification', context,
