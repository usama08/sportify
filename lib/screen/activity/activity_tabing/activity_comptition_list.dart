...
class ActivityCompititionList extends StatefulWidget {
  const ActivityCompititionList({Key? key}) : super(key: key);

  @override
  State<ActivityCompititionList> createState() =>
      _ActivityCompititionListState();
}

class _ActivityCompititionListState extends State<ActivityCompititionList> {
