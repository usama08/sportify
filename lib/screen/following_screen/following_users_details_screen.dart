...
class FollowingUsersDetailScreen extends StatefulWidget {
  const FollowingUsersDetailScreen({Key? key}) : super(key: key);

  @override
  State<FollowingUsersDetailScreen> createState() =>
      _FollowingUsersDetailScreenState();
}

class _FollowingUsersDetailScreenState extends State<FollowingUsersDetailScreen>
